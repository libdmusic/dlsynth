...
int DLSYNTH_EXPORT dlsynth_sound_instr_count(const struct dlsynth_sound *sound,
                                             int *count);
int DLSYNTH_EXPORT dlsynth_sound_instr_info(const struct dlsynth_sound *sound,
                                            int instr, int *bank, int *patch);

int DLSYNTH_EXPORT dlsynth_get_instr_patch(int bank, int patch,
                                           const struct dlsynth_sound *sound,
                                           struct dlsynth_instr **instr);
int DLSYNTH_EXPORT dlsynth_get_instr_num(int instr_num,
                                         const struct dlsynth_sound *sound,
                                         struct dlsynth_instr **instr);
